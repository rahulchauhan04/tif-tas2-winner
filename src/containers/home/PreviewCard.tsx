...
const DataCard: React.FC<{ title: string; children: React.ReactNode }> = ({
  ...
  <Box mt="1rem" bg="white" width="100%" p="16px 24px" borderRadius="10px">
    <Text fontSize="1rem" fontWeight="600" mb="12px">
      {title}
    </Text>
          ...
          <Box width="100%" bgColor="#432B7D" color="white" p="1rem" borderRadius="10px">
            <Flex justifyContent="space-between" alignItems="center">
              <Text fontSize="0.9rem" fontWeight="500">
                {state.requisitionDetails.requisitionTitle || "Title"}
              </Text>
              <Flex alignItems="center">
                <Text fontSize="0.8rem" mr="0.4rem" fontWeight="200">
                  OPENINGS
                </Text>
                <Text fontSize="1rem" fontWeight="bold">
                  {state.requisitionDetails.noOfOpenings || 0}
                </Text>
              </Flex>
            </Flex>
          </Box>
